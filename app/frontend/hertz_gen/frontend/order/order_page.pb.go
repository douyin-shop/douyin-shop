...
func (OrderStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_order_page_proto_enumTypes[0].Descriptor()
}

func (OrderStatus) Type() protoreflect.EnumType {
	return &file_order_page_proto_enumTypes[0]
}
...
type OrderItem struct {
	...
	ImageUrl string    `protobuf:"bytes,4,opt,name=image_url,json=imageUrl,proto3" json:"image_url,omitempty" form:"image_url" query:"image_url"`
}
...
type Order struct {
	...
	Status       OrderStatus  `protobuf:"varint,8,opt,name=status,proto3,enum=frontend.order.OrderStatus" json:"status,omitempty" form:"status" query:"status"`
	CanceledAt   int32        `protobuf:"varint,9,opt,name=canceled_at,json=canceledAt,proto3" json:"canceled_at,omitempty" form:"canceled_at" query:"canceled_at"`
}
...
var file_order_page_proto_rawDesc = []byte{
	...
	0x73, 0x22, 0x7e, 0x0a, 0x09, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x74, 0x65, 0x6d, 0x12, 0x2c,
	...
	0x6c, 0x22, 0x28, 0x0a, 0x0b, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74,
	0x12, 0x19, 0x0a, 0x08, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x07, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x64, 0x22, 0x43, 0x0a, 0x0e, 0x50,
	0x6c, 0x61, 0x63, 0x65, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x12, 0x31, 0x0a,
	0x05, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x66,
	0x72, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x64, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2e, 0x4f, 0x72,
	...
	0x0d, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0xda, 0x02, 0x0a, 0x05, 0x4f, 0x72,
	0x64, 0x65, 0x72, 0x12, 0x3a, 0x0a, 0x0b, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f, 0x69, 0x74, 0x65,
	0x6d, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x66, 0x72, 0x6f, 0x6e, 0x74,
	...
	0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x12, 0x31, 0x0a, 0x07, 0x61, 0x64, 0x64, 0x72,
	0x65, 0x73, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x66, 0x72, 0x6f, 0x6e,
	...
	,
	...
	0x65, 0x73, 0x70, 0x2a, 0x77, 0x0a, 0x0b, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74,
	...
	0x5f, 0x50, 0x45, 0x4e, 0x44, 0x49, 0x4e, 0x47, 0x10, 0x01, 0x12, 0x15, 0x0a, 0x11, 0x4f, 0x52,
	...
	0x53, 0x5f, 0x43, 0x41, 0x4e, 0x43, 0x45, 0x4c, 0x45, 0x44, 0x10, 0x03, 0x32, 0x69, 0x0a, 0x0c,
...
var file_order_page_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_order_page_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_order_page_proto_goTypes = []interface{}{
	(OrderStatus)(0),          // 0: frontend.order.OrderStatus
	(*Address)(nil),           // 1: frontend.order.Address
	(*CartItem)(nil),          // 2: frontend.order.CartItem
	(*PlaceOrderReq)(nil),     // 3: frontend.order.PlaceOrderReq
	(*OrderItem)(nil),         // 4: frontend.order.OrderItem
	(*OrderResult)(nil),       // 5: frontend.order.OrderResult
	(*PlaceOrderResp)(nil),    // 6: frontend.order.PlaceOrderResp
	(*ListOrderReq)(nil),      // 7: frontend.order.ListOrderReq
	(*Order)(nil),             // 8: frontend.order.Order
	(*ListOrderResp)(nil),     // 9: frontend.order.ListOrderResp
	(*MarkOrderPaidReq)(nil),  // 10: frontend.order.MarkOrderPaidReq
	(*MarkOrderPaidResp)(nil), // 11: frontend.order.MarkOrderPaidResp
}
var file_order_page_proto_depIdxs = []int32{
	1, // 0: frontend.order.PlaceOrderReq.address:type_name -> frontend.order.Address
	4, // 1: frontend.order.PlaceOrderReq.order_items:type_name -> frontend.order.OrderItem
	2, // 2: frontend.order.OrderItem.item:type_name -> frontend.order.CartItem
	5, // 3: frontend.order.PlaceOrderResp.order:type_name -> frontend.order.OrderResult
	4, // 4: frontend.order.Order.order_items:type_name -> frontend.order.OrderItem
	1, // 5: frontend.order.Order.address:type_name -> frontend.order.Address
	0, // 6: frontend.order.Order.status:type_name -> frontend.order.OrderStatus
	8, // 7: frontend.order.ListOrderResp.orders:type_name -> frontend.order.Order
	7, // 8: frontend.order.OrderService.ListOrder:input_type -> frontend.order.ListOrderReq
	9, // 9: frontend.order.OrderService.ListOrder:output_type -> frontend.order.ListOrderResp
...
func file_order_page_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_order_page_proto_enumTypes,
