...
type CheckoutReq struct {
	...
	CreditCard *CreditCardInfo `protobuf:"bytes,6,opt,name=credit_card,json=creditCard,proto3" json:"credit_card,omitempty" form:"credit_card" query:"credit_card"`
}
...
type CheckoutResp struct {
	...
	OrderId       string `protobuf:"bytes,1,opt,name=order_id,json=orderId,proto3" json:"order_id,omitempty" form:"order_id" query:"order_id"`                               // 订单号帮助用户去决定跳转到哪个订单页面
	TransactionId string `protobuf:"bytes,2,opt,name=transaction_id,json=transactionId,proto3" json:"transaction_id,omitempty" form:"transaction_id" query:"transaction_id"` // 交易号，用于查询交易状态
}

func (x *CheckoutResp) Reset() {
	*x = CheckoutResp{}
	if protoimpl.UnsafeEnabled {
		mi := &file_checkout_page_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CheckoutResp) Descriptor() ([]byte, []int) {
	return file_checkout_page_proto_rawDescGZIP(), []int{3}
}
...
var file_checkout_page_proto_rawDesc = []byte{
	...
	0x63, 0x68, 0x65, 0x63, 0x6b, 0x6f, 0x75, 0x74, 0x1a, 0x0f, 0x61, 0x70, 0x69, 0x2d, 0x74, 0x6f,
	0x6f, 0x6c, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8f, 0x01, 0x0a, 0x07, 0x41, 0x64,
	...
	0x28, 0x09, 0x52, 0x07, 0x7a, 0x69, 0x70, 0x43, 0x6f, 0x64, 0x65, 0x22, 0xe6, 0x01, 0x0a, 0x0e,
	...
	0x6f, 0x6e, 0x74, 0x68, 0x22, 0xf0, 0x01, 0x0a, 0x0b, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x6f, 0x75,
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x12, 0x34, 0x0a,
	0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a,
	...
	0x65, 0x73, 0x73, 0x12, 0x42, 0x0a, 0x0b, 0x63, 0x72, 0x65, 0x64, 0x69, 0x74, 0x5f, 0x63, 0x61,
	0x72, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x66, 0x72, 0x6f, 0x6e, 0x74,
	0x65, 0x6e, 0x64, 0x2e, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x6f, 0x75, 0x74, 0x2e, 0x43, 0x72, 0x65,
	0x64, 0x69, 0x74, 0x43, 0x61, 0x72, 0x64, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x0a, 0x63, 0x72, 0x65,
	0x64, 0x69, 0x74, 0x43, 0x61, 0x72, 0x64, 0x22, 0x50, 0x0a, 0x0c, 0x43, 0x68, 0x65, 0x63, 0x6b,
	...
	,
...
var file_checkout_page_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_checkout_page_proto_goTypes = []interface{}{
	(*Address)(nil),        // 0: frontend.checkout.Address
	(*CreditCardInfo)(nil), // 1: frontend.checkout.CreditCardInfo
	(*CheckoutReq)(nil),    // 2: frontend.checkout.CheckoutReq
	(*CheckoutResp)(nil),   // 3: frontend.checkout.CheckoutResp
}
var file_checkout_page_proto_depIdxs = []int32{
	0, // 0: frontend.checkout.CheckoutReq.address:type_name -> frontend.checkout.Address
	1, // 1: frontend.checkout.CheckoutReq.credit_card:type_name -> frontend.checkout.CreditCardInfo
	2, // 2: frontend.checkout.CheckoutService.Checkout:input_type -> frontend.checkout.CheckoutReq
	3, // 3: frontend.checkout.CheckoutService.Checkout:output_type -> frontend.checkout.CheckoutResp
...
func file_checkout_page_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_checkout_page_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
