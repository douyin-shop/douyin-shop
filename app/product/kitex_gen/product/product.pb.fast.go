...
func (x *Category) fastReadField4(buf []byte, _type int8) (offset int, err error) {
	x.Level, offset, err = fastpb.ReadUint64(buf, _type)
	return offset, err
}
...
func (x *Product) fastReadField4(buf []byte, _type int8) (offset int, err error) {
	x.ImageName, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}

func (x *Product) fastReadField5(buf []byte, _type int8) (offset int, err error) {
	x.Image, offset, err = fastpb.ReadBytes(buf, _type)
	return offset, err
}
...
func (x *Category) fastWriteField4(buf []byte) (offset int) {
	...
	offset += fastpb.WriteUint64(buf[offset:], 4, x.GetLevel())
	return offset
}
...
func (x *Product) fastWriteField4(buf []byte) (offset int) {
	...
	offset += fastpb.WriteString(buf[offset:], 4, x.GetImageName())
	return offset
}
...
func (x *Product) fastWriteField5(buf []byte) (offset int) {
	...
	offset += fastpb.WriteBytes(buf[offset:], 5, x.GetImage())
	return offset
}
...
func (x *Product) fastWriteField6(buf []byte) (offset int) {
	...
	offset += fastpb.WriteDouble(buf[offset:], 6, x.GetPrice())
	return offset
}
...
func (x *Product) fastWriteField7(buf []byte) (offset int) {
	...
	offset += fastpb.WriteString(buf[offset:], 7, x.GetImageUrl())
	return offset
}
...
func (x *UpdateProductReq) fastWriteField1(buf []byte) (offset int) {
	if x.UpdatedProduct == nil {
		return offset
	}
	offset += fastpb.WriteMessage(buf[offset:], 1, x.GetUpdatedProduct())
	return offset
}
...
func (x *Category) sizeField4() (n int) {
	...
	n += fastpb.SizeUint64(4, x.GetLevel())
	return n
}
...
func (x *Product) sizeField4() (n int) {
	...
	n += fastpb.SizeString(4, x.GetImageName())
	return n
}
...
func (x *Product) sizeField5() (n int) {
	...
	n += fastpb.SizeBytes(5, x.GetImage())
	return n
}
...
func (x *Product) sizeField6() (n int) {
	...
	n += fastpb.SizeDouble(6, x.GetPrice())
	return n
}
...
func (x *Product) sizeField7() (n int) {
	...
	n += fastpb.SizeString(7, x.GetImageUrl())
	return n
}
...
func (x *UpdateProductReq) sizeField1() (n int) {
	...
	n += fastpb.SizeMessage(1, x.GetUpdatedProduct())
	return n
}
